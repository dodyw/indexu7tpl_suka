<?php if (count($lep->tpl["resources"])) : ?>
  ...
  <?php foreach ($lep->tpl["resources"] as $k => $v) { ?>
    ...
    <article class="post row_spacing">
      <h2 class="title"><a title="<?php print $v['title'] ?>" rel="bookmark" href="<?php print seo_detail_url2($v['res_id'], $v['title']) ?>"><?php print $v['title'] ?></a> <span class="featured_tag">Featured</span></h2>
